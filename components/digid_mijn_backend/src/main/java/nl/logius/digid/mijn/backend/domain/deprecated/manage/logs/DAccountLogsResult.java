...
public class DAccountLogsResult extends AccountResult {
    ...
    public static DAccountLogsResult copyFrom(AccountLogsResult result) {
        DAccountLogsResult deprecatedResult = new DAccountLogsResult();
        deprecatedResult.status = result.getStatus();
        deprecatedResult.error = result.getError();
        deprecatedResult.logs = result.getResults();
