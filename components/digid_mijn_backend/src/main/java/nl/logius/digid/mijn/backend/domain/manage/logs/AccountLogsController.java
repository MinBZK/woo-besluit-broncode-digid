...
public class AccountLogsController extends AccountController {

    private AccountService accountService;

    @Autowired
    public AccountLogsController(MijnDigidSessionRepository mijnDigiDSessionRepository, AccountService accountService) {
