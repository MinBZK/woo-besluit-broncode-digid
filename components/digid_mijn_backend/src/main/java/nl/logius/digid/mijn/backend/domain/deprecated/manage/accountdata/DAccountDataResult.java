...
public class DAccountDataResult extends AccountResult {
    ...
    public static DAccountDataResult copyFrom(AccountDataResult result){
        DAccountDataResult deprecatedResult = new DAccountDataResult();

        deprecatedResult.setStatus(result.getStatus());
        deprecatedResult.setError(result.getError());
        deprecatedResult.setEmailStatus(result.getEmailStatus());
        deprecatedResult.setCurrentEmailAddress(result.getCurrentEmailAddress());
        deprecatedResult.setSetting2Factor(result.getSetting2Factor());
        deprecatedResult.setUnreadNotifications(result.getUnreadNotifications());
        deprecatedResult.setClassifiedDeceased(result.getClassifiedDeceased());
