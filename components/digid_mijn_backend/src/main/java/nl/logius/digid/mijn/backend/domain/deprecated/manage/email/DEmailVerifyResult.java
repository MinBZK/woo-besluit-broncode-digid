...
public class DEmailVerifyResult extends AccountResult {
    ...
    public static DEmailVerifyResult copyFrom(EmailVerifyResult result) {
        DEmailVerifyResult deprecatedResult = new DEmailVerifyResult();
        deprecatedResult.status = result.getStatus();
        deprecatedResult.error = result.getError();
        deprecatedResult.remainingAttempts = result.getRemainingAttempts();
