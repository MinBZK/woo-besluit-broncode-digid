...
public class ServiceControllerTest {
    ...
    public void getServiceByName() {
        ...
        when(serviceServiceMock.getServiceByName("test")).thenReturn(service);
        Service result = controller.getByName("test");

        assertEquals("test", result.getName());
        verify(serviceServiceMock, times(1)).getServiceByName(anyString());
    }
    ...
    @Test
    public void serviceIdNotFound() {
        when(serviceServiceMock.getServiceById(anyLong())).thenThrow(NotFoundException.class);
        assertThrows(NotFoundException.class, () -> {
            controller.getById(anyLong());
        });
    }
}
