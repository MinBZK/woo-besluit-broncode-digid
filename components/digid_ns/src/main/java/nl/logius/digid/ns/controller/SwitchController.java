...
public class SwitchController {
    ...
    @GetMapping(value = "ns_switches.json", produces = "application/json")
    @ResponseBody
    @Operation
    ...
    @GetMapping(value = "ns_switches/{id}.json", produces = "application/json")
    @ResponseBody
    @Operation
    ...
    @PutMapping(value = "ns_switches/{id}.json", produces = "application/json")
