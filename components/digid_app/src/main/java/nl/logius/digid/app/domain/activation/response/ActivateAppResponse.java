...
public class ActivateAppResponse extends StatusResponse {
    ...
    public ActivateAppResponse(Integer authenticationLevel) {
        super("OK");
        this.authenticationLevel = authenticationLevel;
    }

    public ActivateAppResponse(String status, Integer authenticationLevel) {
        super(status);
        this.authenticationLevel = authenticationLevel;
    }
