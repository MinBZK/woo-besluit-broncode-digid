...
public abstract class AuthenticationFlow extends Flow {
    protected AuthenticationFlow(AppAuthenticatorService appAuthenticatorService, DigidClient digidClient, NsClient nsClient, AppSessionService appSessionService, FlowFactory flowFactory, Map<BaseState, Map<BaseAction, BaseState>> allowedTransitions, String name) {
