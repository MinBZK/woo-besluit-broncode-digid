...
public class WidUpgradeRequest extends AppSessionRequest {
    ...
    public List<String> getAndroidCertificates() {
        return androidCertificates;
    }

    public void setAndroidCertificates(List<String> androidCertificates) {
        this.androidCertificates = androidCertificates;
    }
