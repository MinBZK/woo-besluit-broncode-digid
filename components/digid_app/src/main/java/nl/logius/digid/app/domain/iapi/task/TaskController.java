...
public class TaskController {
    ...
    @Autowired
    public TaskController(ScheduledTasksService service) {
    ...
    public ResponseEntity<Map<String, Object>> performScheduleTask(final @RequestBody ScheduledTask task) throws SharedServiceClientException {
        service.processScheduledTask(task.getIapi().get("name"));
