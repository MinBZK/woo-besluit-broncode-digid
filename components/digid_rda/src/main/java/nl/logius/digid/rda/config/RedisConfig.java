...
import nl.logius.digid.rda.models.converters.AppSessionToByteArrayConverter;
import nl.logius.digid.rda.models.converters.ByteArrayToAppSessionConverter;
...
public class RedisConfig {
    ...
    public RedisCustomConversions redisCustomConversions() {
        return new RedisCustomConversions(Arrays.asList(
                new AppSessionToByteArrayConverter(),
                new ByteArrayToAppSessionConverter()
        ));
    }
}
