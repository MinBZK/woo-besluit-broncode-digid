...
public class DigidXClient extends IapiClient {
    ...
    public DigidXClient(HttpUrl url, String authToken, int timeout) {
    ...
    public void sendNotification (String bsn, String docType) {
        final Map<String, String> Body = new ImmutableMap.Builder<String, String>()
            .put("bsn", bsn)
            .put("docType", docType)
            .build();
        postJsonRequest("send_pin_request_notification", Body);
    }
