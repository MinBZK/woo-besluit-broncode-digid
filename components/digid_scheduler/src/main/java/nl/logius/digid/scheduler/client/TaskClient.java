...
public class TaskClient extends IapiClient {

    private final Logger logger = LoggerFactory.getLogger(getClass());

    public TaskClient(HttpUrl url, String authToken, int timeout) {
        super(url, authToken, timeout);
    }

    public void callCronJob(String jobName) {
        final Map<String, Object> content = new HashMap<>();
        content.put("name", jobName);
