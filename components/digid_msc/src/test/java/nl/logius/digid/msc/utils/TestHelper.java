...
package nl.logius.digid.msc.utils;
...
public class TestHelper {
    ...
    public static RegisterStatusSCRequest generateSoapRequest(Resource request) throws XmlUtilsException, IOException {
        return XmlUtils.readSoapMessageFromStreamAndUnmarshallBody2Object(request.getInputStream(), RegisterStatusSCRequest.class);
    }

    public static <T> T sendResourceSoapRequest(final Resource request, Class<T> responseClass, final int port) throws XmlUtilsException, IOException {
