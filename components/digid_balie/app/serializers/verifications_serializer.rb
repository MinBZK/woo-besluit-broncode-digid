...
class VerificationsSerializer < ActiveModel::Serializer
  attributes :id, :citizen_service_number, :id_number,
             ...
             :front_desk_registration_created_at, :id_signaled, 
             :nationality
  has_one :front_desk
  has_one :user, serializer: UserSerializer
  has_one :audit, serializer: AuditSerializer
  has_one :verification_correction
end
