...
package nl.logius.digid.logger.controllers;
...
import nl.logius.digid.logger.Application;

@RestController
public class VersionController implements BaseController {
    @ApiOperation("Get the version of the application")
    @GetMapping(value = "/iapi/version", produces = "application/json")
    @ResponseBody
