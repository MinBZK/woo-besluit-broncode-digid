...
import nl.logius.digid.eid.models.converters.ByteArrayToEcPrivateKeyConverter;
import nl.logius.digid.eid.models.converters.EcPrivateKeyToByteArrayConverter;
...
public class RedisConfig {
    ...
    public RedisCustomConversions redisCustomConversions() {
        return new RedisCustomConversions(Arrays.asList(
            ...
            new ByteArrayToEcPrivateKeyConverter(),
            new EcPrivateKeyToByteArrayConverter()
        ));
    }
}
