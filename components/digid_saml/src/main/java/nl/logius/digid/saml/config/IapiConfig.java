...
public class IapiConfig {
    ...
    @Value("${urls.internal.dc}")
    private String dcClientBaseUrl;
    ...
    public AdClient adClient() {
        return new AdClient(HttpUrl.get(digidXBaseUrl), iapiToken, timeout);
    }

    @Bean
    public DienstencatalogusClient dcClient() {
        return new DienstencatalogusClient(HttpUrl.get(dcClientBaseUrl), iapiToken, timeout);
    }
