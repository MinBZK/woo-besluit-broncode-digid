...
@Service
public class EntranceMetadataService extends MetadataService {
    private static final String METADATA_TYPE ="TD";

    @Autowired
    public EntranceMetadataService(
            XMLObjectBuilderFactory builderFactory,
            @Value("${metadata.entrance_entity_id}") String entityID,
            @Value("${saml.entrance_store}") String keystoreFile,
            @Value("${saml.entrance_store_passphrase}") String keystorePassword) {
