...
class SentEmail < ActiveRecord::Base
  ...
  module Reason
    ...
    EMAIL_APP                   = "Controle e-mail (app)" # ED029
    ...
    PINPUK_WID                  = "Notificatie PIN-brief identiteitsbewijs aangevraagd" # EB005
    ...
    APP_AND_ACCOUNT_ACTIVATED   = "Notificatie DigiD en DigiD app geactiveerd" # ED026
    SMS_DEACTIVATED             = "Notificatie sms-controle gedeactiveerd en telefoonnummer verwijderd" #ED030
    ACCOUNT_REMOVED             = "Notificatie opheffen DigiD account (vanuit Mijn DigiD)" #ED031
    APP_DEACTIVATED             = "Notificatie DigiD app gedeactiveerd" #ED032
  end
end
