...
class ApplicationMailer < ActionMailer::Base
  ...
  def i18n_mail(options)
    ...
    I18n.with_locale(locale) do
      ...
      mail(options) do |format|
        ...
        format.text { render options[:template] }
      end
    end
  end
  ...
  def add_inline_attachments
    attachments.inline["rijkslogo_op_wit-compressed.png"] = Rails.root.join("public/rijkslogo_op_wit-compressed.png").read
    attachments.inline["digid.png"] = Rails.root.join("public/digid.png").read
    attachments.inline["rijksblauw_op_wit-compressed.png"] = Rails.root.join("public/rijksblauw_op_wit-compressed.png").read
  end
end
