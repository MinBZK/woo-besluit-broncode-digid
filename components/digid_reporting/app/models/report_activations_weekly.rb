...
class ReportActivationsWeekly < AdminReport
  def self.report_name
    'Aantal activeringen DigiD accounts per week'
  end

  def self.report(start_date = nil)
      # BRON  : week_maandRaportage.csv rij 27
      # RETURN: aantal
      # JOINS :
      ...
      logger.info "aantal_activeringen_DigiD_accounts_weekly ===> Result for aantal_activeringen_DigiD_accounts_weekly: #{result}"
    return result
  end
end
