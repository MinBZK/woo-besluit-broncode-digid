...
class ReportSuccessAuthOrgMonthly < AdminReport
  ...
  def self.report_name
    'Aantal gelukte authenticaties per organisatie per sector'
  end
  ...
  def self.list_organizations(ts,qry_result)
    result = [["Maand", "Organization Name", "Organization Id", "Webservice Name", "Sector Name", "Counter"]]
