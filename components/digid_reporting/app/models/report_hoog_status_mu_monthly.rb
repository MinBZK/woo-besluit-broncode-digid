...
# afgelopen periode.
class ReportHoogStatusMuMonthly < AdminReport
 def self.report_name
   'Aantal verstuurde DigiD Hoog statuswijzigingen per dag per status per MU'
  end

  def self.report(start_date = nil)
    rep = ReportHoogStatusMu.new(ReportParam::MONTH)
