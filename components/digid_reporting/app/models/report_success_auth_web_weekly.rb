...
class ReportSuccessAuthWebWeekly < AdminReport
  ...
  def self.report_name
    'Aantal gelukte authenticaties per webdienst per sector per week'
  end

  def self.report(start_date = nil)
    rep = ReportAuthWeb.new(ReportParam::WEEK, UC_LABELS)
