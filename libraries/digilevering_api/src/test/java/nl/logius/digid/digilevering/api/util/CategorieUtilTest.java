...
public class CategorieUtilTest {
    ...
    @Test
    public void testFindOldBsn(){assertThat(CategorieUtil.findBsnOudeWaarde(createFullCategories()), is("burgerservicenummer_oud"));}
    ...
    private List<Container> createFullCategories() {
        ...
        categories.add(
                CategorieUtil.createCategorie(
                        CategorieUtil.CATEGORIE_IDENTIFICATIENUMMERS_OUDE_WAARDE,
                        CategorieUtil.ELEMENT_BURGERSERVICENUMMER, "burgerservicenummer_oud"
                        )
        );
        categories.add(
                CategorieUtil.createCategorie(
