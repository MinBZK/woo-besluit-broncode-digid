...
public class Utf8StringConverter extends SimpleConverter<String> {
    @Override
    public String deserialize(Asn1ObjectInputStream in) {
        return new String(in.readAll(), StandardCharsets.UTF_8);
    }

    @Override
    public void serialize(Asn1OutputStream out, String obj) {
