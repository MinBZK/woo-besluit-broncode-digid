...
public class BigIntegerConverter extends SimpleConverter<BigInteger> {
    @Override
    public BigInteger deserialize(Asn1ObjectInputStream in) {
        return new BigInteger(1, in.readAll());
    }
