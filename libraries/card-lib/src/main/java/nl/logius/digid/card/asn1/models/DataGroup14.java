...
@Asn1Entity(tagNo = 0x6e)
public class DataGroup14 implements Serializable {
    private static final long serialVersionUID = 1L;

    private SecurityInfos securityInfos;
    ...
    public void setSecurityInfos(SecurityInfos securityInfos) {
