...
public class TDEASecureMessagingTest {
    private static final byte[] SEED = Hex.decode("0123456789ABCDEF");
    private static final byte[] SSC = Hex.decode("FEDCBA9876543210");
    ...
    public void shouldEncryptCommandAPDU() {
        final SecureMessaging sm = new TDEASecureMessaging(SEED, SSC);
